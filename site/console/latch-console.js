...
(function () {
  ...
  function renderTokenHelp() {
    ...
    // GitHub's documented fine-grained prefill (see fineGrainedTokenUrl in
    // core): name, owner, expiry and every permission. Only the user can press
    // Generate.
    ...
    $('fineGrainedOwnerNote').textContent = state.owner
      ? 'This link pre-selects ' + state.owner + ', a 90-day expiration and the permissions in the table. Give the form a glance, pick the repository, then press Generate.'
